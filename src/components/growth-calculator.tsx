    ...
    <section id="roi-calculator" className="relative overflow-hidden py-20 sm:py-24 md:py-32 bg-background w-full max-w-full">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-[5fr_6fr]">
          {/* Controls Panel */}
          <Reveal delay={0.15}>
            <div className="relative h-full rounded-3xl border border-border bg-card p-5 sm:p-6 md:p-8 shadow-sm w-full max-w-full overflow-hidden">
              <div className="flex items-center justify-between border-b border-border pb-5">
                <div>
                  ...
                  <h3 className="mt-1 font-heading text-lg sm:text-xl font-bold text-foreground">{selectedIndustry.name} Inputs</h3>
                </div>
              ...
              <div className="mt-6 space-y-3">
                <div className="flex items-center justify-between text-sm font-semibold">
                  ...
                  <span className="font-heading text-base sm:text-lg font-extrabold text-[#0284C7] dark:text-[#38BDF8]">
              ...
              <div className="mt-8 rounded-2xl border border-border bg-muted/40 p-4 sm:p-5">
          ...
          <Reveal delay={0.2}>
            <div className="relative flex h-full flex-col justify-between overflow-hidden rounded-3xl border border-[#0284C7]/30 bg-card p-5 sm:p-6 md:p-8 shadow-xl w-full max-w-full">
              {/* Top Accent Strip */}
              ...
              <div>
                ...
                {/* Big Metric Display */}
                <div className="mt-6 rounded-2xl border border-border bg-muted/30 p-5 sm:p-6 backdrop-blur">
                  <div className="text-xs font-bold uppercase tracking-wider text-muted-foreground">
                    Estimated Annual Pipeline Lift
                  </div>
                  <div className="mt-2 flex items-baseline gap-1 font-heading text-3xl sm:text-4xl font-extrabold text-[#0284C7] dark:text-[#38BDF8] md:text-5xl">
                    <span>+$</span>
                    <Counter
                ...
                <div className="mt-4 grid grid-cols-2 gap-3 sm:gap-4">
                  <div className="rounded-2xl border border-border bg-card p-3.5 sm:p-4 shadow-sm">
                    ...
                    <div className="mt-2 font-heading text-lg sm:text-xl font-bold text-foreground">
                      {selectedIndustry.velocityBoost}
                    </div>
                    <div className="mt-1 text-[0.72rem] sm:text-[0.75rem] text-muted-foreground">
                      Cycle acceleration
                    </div>
                  </div>
              ...
              <div className="mt-8 pt-4 border-t border-border">
                <Button
                  asChild
                  size="lg"
                  className="min-h-12 sm:h-13 h-auto w-full gap-2 rounded-xl bg-gradient-to-r from-[#0284C7] to-[#0369A1] text-sm sm:text-base font-bold text-white shadow-xl shadow-[#0284C7]/25 hover:shadow-2xl hover:shadow-[#0284C7]/35 hover:-translate-y-0.5 transition-all whitespace-normal py-3 px-4 text-center"
                >
                  <Link href={`/contact?industry=${selectedIndustry.id}&volume=${volume}`} className="flex items-center justify-center gap-2">
                    <span>Build Strategy Based on This Model</span>
