...
const servicesList = [
  ...
  {
    title: 'AI Agents & Enterprise Platforms',
    desc: 'Autonomous AI agents, custom platforms, and workflow automation.',
  ...
  },
  {
    ...
    desc: 'Admissions funnel journeys, positioning, and EdTech growth.',
